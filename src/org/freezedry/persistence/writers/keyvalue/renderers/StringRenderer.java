...
public class StringRenderer extends AbstractPersistenceRenderer {
	
	private static final Logger LOGGER = Logger.getLogger( StringRenderer.class );

	public StringRenderer( final KeyValueWriter writer )
	{
		super( writer );
	}
	
	public StringRenderer( final StringRenderer renderer )
	{
		super( renderer );
	}
